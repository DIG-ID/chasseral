<section id="section-hotel-restaurant" class="section-hotel-restaurant__intro xl:h-screen grid grid-cols-1 lg:grid-rows-2">
    ...
    <div class="flex justify-center h-full w-full">
        <div class="py-10 lg:py-20 container grid grid-cols-1 lg:grid-cols-8 gap-8 justify-center p-8">
            ...
            <div class="col-span-5 xl:grid xl:grid-rows-2">
                ...
                <div class="row-span-1">
                    <a href="https://u86ev3bgmql.preview.infomaniak.website/" target="_blank" class="btn-general btn-general--hotel is-checked"><?php echo esc_html_e( 'Jetzt Buchen', 'chasseral' ) ?></a>
                </div>
            </div>
        </div>
    </div>
