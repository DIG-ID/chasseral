<section class="section-2cols-image grid grid-cols-1 lg:grid-cols-2 border-y border-solid">
    <div class="flex justify-center p-8 lg:p-20 pb-24 lg:pb-20 flex-col order-2 lg:order-1">
    ...
    <div class="bg-cover bg-center h-full w-full chasseral__col border-l border-solid order-1 lg:order-2">
