<section class="chasseral-preview-section pt-40 pb-[30rem] bg-no-repeat" style="background-image: url(<?php echo wp_upload_dir()['url'] . '/chasseral_illustration.svg' ?>);    background-position: 0 100%;">
