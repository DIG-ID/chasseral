...
if ( $iframe ) :
	?>
	<section id="360-webcam" class="section-webcam py-16 lg:py-32 border-t border-solid border-black overflow-hidden">
		<div class="container mx-auto px-8">
			<h2 class="section-title text-xl lg:text-3xl font-bold mb-16"><?php the_field( 'webcam_title' ); ?></h2>
