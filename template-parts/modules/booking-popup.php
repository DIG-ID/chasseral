<div class="hidden">
    <div class="relative max-w-[950px] flex justify-center align-middle pt-24 pb-16 px-8 lg:p-32 mt-12 border border-solid" id="open" title="cenas">
        ...
        <p class="text-lg md:text-2xl leading-10 text-center text-black mb-12 max-w-md"><?php esc_html_e( 'Zimmerreservationen können nur telefonisch während der Öffnungszeiten entgegen genommen werden.', 'chasseral' ); ?></p>
        <p class="text-lg md:text-2xl leading-10 text-center text-black"><b><?php esc_html_e( 'Tel. 032 751 24 51', 'chasseral' ); ?></b></p>
    </div>
</div>