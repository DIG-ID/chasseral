...
if ( $gallery ) : ?>
<section id="single-perfekt-fur-gallery" class="section-perfekt-fur__gallery p-0">
        ...
        <?php
            ...
            foreach ( $gallery as $image ) :
                echo '<div class="swiper-slide">';
                echo '<img class="w-full h-auto object-cover max-h-[150px] cursor-pointer" src="' . esc_url( $image['sizes']['thumbnail'] ) . '">';
                echo '</div>';
            endforeach;
            echo '</div></div>';
        ?>
