<section id="single-perfekt-fur-intro" class="section-perfekt-fur__intro grid grid-cols-1">
	<div class="w-full chasseral__col">
		...
		<div class="p-8 lg:py-40 container max-w-7xl mx-auto">
			...
			<a href="<?php echo esc_url( get_permalink( get_field( 'archives_pages_perfekt_fur', 'options' ) ) ); ?>" class="inline-block mt-10"><svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="inline mr-2">
