<article id="post-<?php the_ID(); ?>" <?php post_class( 'overflow-hidden py-20' ); ?>>
	<div class="container mx-auto px-8 grid grid-cols-12">
		<div class="post-content-wrapper col-span-10">
			...
			<a href="<?php echo get_permalink( get_field( 'agenda_events_events_page', 'options' ) ); ?>" class="inline-block mt-10"><svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="inline mr-2">
