<article id="post-<?php the_ID(); ?>" <?php post_class( 'card-agenda overflow-hidden mb-20' ); ?>>
	<div class="card-agenda-wrapper grid lg:grid-cols-2">
		<div class="card-agenda-image border border-solid border-black order-2 lg:order-1">
			<?php
		...
		<div class="card-agenda-content flex flex-col justify-center items-start px-16 py-16 lg:py-0 border border-solid border-black lg:border-l-0 order-1 lg:order-2">
