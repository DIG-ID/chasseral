<article id="post-<?php the_ID(); ?>" <?php post_class( 'card-event overflow-hidden mb-20 border lg:border-0' ); ?>>
	<div class="card-event-wrapper grid grid-cols-1 lg:grid-cols-2">
		<div class="card-event-image lg:border border-solid border-black">
			<?php
		...
		<div class="card-event-content flex flex-col justify-center items-start pl-8 lg:pl-16 pt-8 lg:pt-0 pr-8 lg:pr-0 pb-8 lg:pb-0 lg:border lg:border-solid border-black lg:border-l-0">
			...
			<h3 class=" text-2xl lg:text-3xl font-bold mb-6"><?php the_title(); ?></h3>
