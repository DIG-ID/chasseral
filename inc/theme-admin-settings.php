...
function theme_login_logo() {
	...
	h1 a {
		background-image: url(' . get_template_directory_uri() . '/assets/images/chasseral-main.min.svg) !important;
	}
	body {
		background-image: url(' . get_template_directory_uri() . '/assets/images/chasseral-mountains.min.svg) !important;
	}
	</style>';
}
